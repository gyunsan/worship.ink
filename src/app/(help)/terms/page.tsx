    ...
    <div className='w-full flex justify-center items-center'>
      <div className='w-8/12'>
        ...
        <div className='mx-auto max-w-2xl text-center'>
          <h2 className='text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl'>Terms and Conditions</h2>
          <p className='m-6 text-xs text-gray-600'>
            These terms and conditions outline the rules and regulations for the use of Vector Web's Website, located at 
            <Link className="text-blue-700" href='/'> https://recipoyo.com</Link>.
          </p>
        </div>

        <p>
          By accessing this website we assume you accept these terms and conditions. Do not continue to use recipoyo if
        ...
        <p>
          We employ the use of cookies. By accessing recipoyo, you agreed to use cookies in agreement with Vector Web's
          Privacy Policy.{' '}
        </p>
        ...
        <p>
          Unless otherwise stated, Vector Web and/or its licensors own the intellectual property rights for all material
          on recipoyo. All intellectual property rights are reserved. You may access this from recipoyo for your own
          personal use subjected to restrictions set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul className="list-disc ml-6 m-2">
          <li>Republish material from recipoyo</li>
          <li>Sell, rent or sub-license material from recipoyo</li>
          <li>Reproduce, duplicate or copy material from recipoyo</li>
          <li>Redistribute content from recipoyo</li>
        </ul>
        ...
        <p>
          ...
          areas of the website. Vector Web does not filter, edit, publish or review Comments prior to their presence on
          the website. Comments do not reflect the views and opinions of Vector Web,its agents and/or affiliates.
          Comments reflect the views and opinions of the person who post their views and opinions. To the extent
          permitted by applicable laws, Vector Web shall not be liable for the Comments or for any liability, damages or
          expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments
          on this website.
        </p>

        <p>
          Vector Web reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <p>
          You hereby grant Vector Web a non-exclusive license to use, reproduce, edit and authorize others to use,
        ...
        <p>
          ...
          records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Vector
          Web; and (d) the link is in the context of general resource information.
        </p>
        ...
        <p>
          ...
          you must inform us by sending an e-mail to Vector Web. Please include your name, your organization name,
        ...
        <p>
          No use of Vector Web's logo or other artwork will be allowed for linking absent a trademark license agreement.
        </p>
      ...
      <RightSidebar>Some text here</RightSidebar>
    </div>
  )
}
