  ...
  return (
    <div className='w-full flex justify-center items-center'>
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Cookie Policy</h2>
        <p className='m-6 text-xs'>
        This is the Cookie Policy for recipoyo, accessible from <Link href='/'> https://recipoyo.com</Link>.
        </p>
      </div>
        ...
        <ul className="list-disc ml-6 m-2">
          ...
          <li>
            ...
            <p>
              From time to time we offer user surveys and questionnaires to provide you with interesting insights,
        ...
        <ul className="list-disc ml-6 m-2">
          ...
          <li>
            <p>
              The Google AdSense service we use to serve advertising uses a DoubleClick cookie to serve more relevant
          ...
          <li>
            <p>
              We use adverts to offset the costs of running this site and provide funding for further development. The
              behavioural advertising cookies used by this site are designed to ensure that we provide you with the most
              relevant adverts where possible by anonymously tracking your interests and presenting similar things that
              may be of interest.
            </p>
          </li>
          ...
          <li>
            <p>
              ...
              may be used to enhance your profile on their site or contribute to the data they hold for various purposes
        ...
        <ul className="list-disc ml-6 m-2">
          <li>Email: info@recipoyo.com</li>
          <li>
            By visiting this link: <Link href='/'> https://recipoyo.com</Link>
          </li>
        </ul>
      </div>
    </div>
