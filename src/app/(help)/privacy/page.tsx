      ...
      <div className='w-8/12'>
        ...
        <div className='mx-auto max-w-2xl text-center'>
          ...
          <p className='m-6 text-xs text-gray-600'>
            At recipoyo, accessible from <Link href='/'> https://recipoyo.com</Link>, one of our main priorities is the
            privacy of our visitors. This Privacy Policy document contains types of information that is collected and
            recorded by recipoyo and how we use it.
          </p>
        </div>
        ...
        <p>
          ...
          regards to the information that they shared and/or collect in recipoyo. This policy is not applicable to any
        ...
        <p>
          recipoyo follows a standard procedure of using log files. These files log visitors when they visit websites.
          All hosting companies do this and are a part of hosting services' analytics. The information collected by log
          files includes internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time
        ...
        <p>
          Like any other website, recipoyo uses 'cookies'. These cookies are used to store information including
        ...
        <p>
          Google is one of the third-party vendors on our site. It also uses cookies, known as DART cookies, to serve
          ads to our site visitors based upon their visit to www.website.com and other sites on the internet. However,
        ...
        <p>
          Some of the advertisers on our site may use cookies and web beacons. Our advertising partners are listed
          below. Each of our advertising partners has its own Privacy Policy for their policies on user data. For easier
        ...
        <p>You may consult this list to find the Privacy Policy for each of the advertising partners of recipoyo.</p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used
          in their respective advertisements and links that appear on recipoyo, which are sent directly to users'
        ...
        <p>
          Note that recipoyo has no access to or control over these cookies that are used by third-party advertisers.
        </p>

        <h3 className="text-xl font-semibold py-6">Third Party Privacy Policies</h3>

        <p>
          recipoyo's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
        ...
        <h3 className="text-xl font-semibold py-6">CCPA Privacy Rights (Do Not Sell My Personal Information)</h3>
        ...
        <p>
          recipoyo does not knowingly collect any Personal Identifiable Information from children under the age of 13.
